...
export default function NextMovesList({
  ...
  return (
    <div
      className={cn(
        "h-[252px] max-h-[252px]",
        "outline outline-gray-200 p-2 rounded ml-1",
      )}
    >
      <div className="grid grid-flow-col grid-rows-5 gap-2 h-full">
            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  "w-[160px] max-w-[160px] min-h-[42px] max-h-[42px] cursor-pointer overflow-hidden",
                )}
